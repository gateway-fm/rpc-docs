---
description: This method is used to register a Stark key that corresponds to an Ethereum public address. This will return user configuration details.
---
# Register
...
```bash
curl https://rpc.gateway.fm/v1/starkex/{prod|stg}/trading/w/register \
-X POST \
...
```javascript
{
    ...
    "ethAddress": "0xb42bf7bb1cc2a5bb39beed296b7c06ccc54507c7",
    "isRegistered": true
}
```
